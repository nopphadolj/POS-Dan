...
$(document).ready(() => {
  ...
  let config = {
    ...
    url: 'https://script.google.com/macros/s/AKfycbyK8zfw11qz74oaBqvbHnk7eGAnTCuZcxHSTi7FUxuADWvbM61YvoCi5rM0H2CxMMb4qg/exec?type=1',
    headers: { },
    data : ""
  };
